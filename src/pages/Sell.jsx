...
import dataRaw from "../data/listings.json";                 // ← comme BuyIntro.jsx :contentReference[oaicite:0]{index=0}
import BandCarousel from "../components/BandCarousel.jsx";  // ← même composant que sur Acheter :contentReference[oaicite:1]{index=1}
...
/* ---------- helpers data (copié façon BuyIntro) ---------- */
...
// on garde le mapping numérique (utile si tu réutilises prix/surface plus tard)
...
/* ---------- hook reveal (même logique que BuyIntro) ---------- */
...
/* ---------- visuels étapes ---------- */
const HERO_URL = "https://images.pexels.com/photos/27303113/pexels-photo-27303113.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=1920";
const SELL_1 = "https://images.pexels.com/photos/8297537/pexels-photo-8297537.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=2400";
const SELL_2 = "https://images.pexels.com/photos/20451400/pexels-photo-20451400.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=2400";
const SELL_3 = "https://images.pexels.com/photos/6476808/pexels-photo-6476808.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=2000";
const SELL_4 = "https://images.pexels.com/photos/7641868/pexels-photo-7641868.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=2400";
const SELL_5 = "https://images.pexels.com/photos/8293778/pexels-photo-8293778.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=2400";

/* ---------- contenu étapes ---------- */
const steps = [
  { id:"estimation-strategie", title:"Estimation & stratégie", icon:Target, bullets:[
  ...
  { id:"mise-en-valeur", title:"Mise en valeur du bien", icon:Camera, bullets:[
    "Photos pro, vidéo ciné, drone, plans 2D/3D.",
    "Recommandations de home staging à fort impact.",
    "Annonce claire, premium et factuelle.",
  ]},
  { id:"diffusion-ciblage", title:"Diffusion & ciblage", icon:Megaphone, bullets:[
  ...
  { id:"visites-offres", title:"Visites qualifiées", icon:Users, bullets:[
  ...
  { id:"closing-notaire", title:"Signature & suivi", icon:FileText, bullets:[
...
export default function Sell() {
  ...
  // données “déjà vendu” — même filtre que BuyIntro (vendu tag ou flag) :contentReference[oaicite:2]{index=2}
  const vendus = useMemo(
    () => data.filter((d) => hasTag(d, /vendu/i) || d.vendu),
    []
  );

  // apparition “déjà vendu” — même anim que BuyIntro :contentReference[oaicite:3]{index=3}
  ...
  return (
    <main className="text-[#0F1115] overflow-x-clip">
      ...
      {/* BANDEAU KPI (même anim/taille/placement que Acheter) */}
      <SellTrustStrip />

      {/* DÉJÀ VENDU — mêmes données / même pattern que BuyIntro */}
      <section
        ref={vendRef}
